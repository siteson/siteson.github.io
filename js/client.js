...
(function (require) {
	...
	a["og:title"]=m?m.content:"",a.token=i,document.head.insertAdjacentHTML("afterbegin","<style>\n    .utterances {\n      position: relative;\n      box-sizing: border-box;\n      width: 100%;\n      max-width: 760px;\n      margin-left: auto;\n      margin-right: auto;\n    }\n    .utterances-frame {\n      position: absolute;\n      left: 0;\n      right: 0;\n      width: 1px;\n      min-width: 100%;\n      max-width: 100%;\n      height: 100%;\n      border: 0;\n    }\n  </style>");
	var n=b.src.match(/^https:\/\/utteranc\.es|http:\/\/localhost:\d+/)[0],o=n+"/utterances.html";
